...
public class ManageViolation extends AppCompatActivity {
    ...
    private static String urlHostFN = "http://192.168.1.12/TicketingSystem/selectViolationFN.php";
    private static String urlHostDOB = "http://192.168.1.12/TicketingSystem/selectViolationDOB.php";
    private static String urlHostLN = "http://192.168.1.12/TicketingSystem/selectViolationLicense.php";
    private static String urlHostTOV = "http://192.168.1.12/TicketingSystem/selectViolationTOV.php";
    private static String urlHostDelete = "http://192.168.1.12/TicketingSystem/delete.php";
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                alert_confirm.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        tov = txtDefault_TOV.getText().toString().trim();
                        ...
                        intent.putExtra(EditViolation.TOV, tov);
    ...
    private class delete extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String del) {
            ...
            if (ln != null) {
                ...
                Toast.makeText(ManageViolation.this, "Data Deleted", Toast.LENGTH_SHORT).show();
            } else {
                alert.setMessage("Query Interrupted... \nPlease Check Internet connection");
                alert.setTitle("Error");
                alert.show();
